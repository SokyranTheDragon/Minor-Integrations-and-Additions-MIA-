package com.github.sokyranthedragon.mia.gui.client.buttons;
...
public class GuiButtonImageDisableable extends GuiButton
{
    ...
    public GuiButtonImageDisableable(int buttonId, int x, int y, int width, int height, int textureOffsetX, int textureOffsetY, int variantOffsetY, ResourceLocation resource)
    {

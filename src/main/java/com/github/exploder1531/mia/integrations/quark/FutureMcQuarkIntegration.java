...
import static com.github.exploder1531.mia.integrations.ModIds.FUTURE_MC;
...
class FutureMcQuarkIntegration implements IFutureMcIntegration
{
    ...
    {
        boolean soulSandstoneEnabled = isFeatureEnabled(SoulSandstone.class);
...
//            registerSlabs(new ItemStack(SoulSandstone.soul_sandstone), "soul_sandstone");
        ...
        if (isFeatureEnabled(VanillaWalls.class))
        {
        ...
        if (isFeatureEnabled(VanillaStairsAndSlabs.class))
        {
        ...
        if (isFeatureEnabled(PolishedStone.class))
        {
        ...
        if (isFeatureEnabled(SandyBricks.class))
        {
        ...
        if (isFeatureEnabled(SnowBricks.class))
        {
        ...
        if (isFeatureEnabled(MagmaBricks.class) && MagmaBricks.enableStairsAndSlabs)
        {
            registerStairsAndSlabs(new ItemStack(MagmaBricks.magma_bricks), "magma_bricks");
        }
        
        if (isFeatureEnabled(DuskboundBlocks.class))
        {
